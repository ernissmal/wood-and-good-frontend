...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Base price for this size in Character grade Oak Rectangular',
    }),
    defineField({
      name: 'priceByQuality',
      title: 'Price by Quality Grade (€)',
      type: 'object',
      fields: [
        {
          name: 'rustic',
      ...
      description: 'Actual prices for each quality grade (Oak Rectangular baseline)',
    }),
    defineField({
      name: 'surfaceArea',
      title: 'Surface Area (m²)',
      type: 'number',
      description: 'Calculated surface area for pricing calculations',
      readOnly: true,
    }),
    defineField({
