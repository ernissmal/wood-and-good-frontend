          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <LocationOnIcon className="icon-md mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <EmailIcon className="icon-md mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <LocalShippingIcon className="icon-md mt-0.5 flex-shrink-0" />
                <div>
        ...
        <div className="border-t border-oak-700 pt-8 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex items-center justify-center space-x-3">
              <NatureIcon className="icon-xl text-forest-400" />
            ...
            <div className="flex items-center justify-center space-x-3">
              <HandymanIcon className="icon-xl text-oak-400" />
              <div className="text-left">
            ...
            <div className="flex items-center justify-center space-x-3">
              <LocalShippingIcon className="icon-xl text-oak-400" />
              <div className="text-left">
                <p className="footer-text-bold">Free Delivery</p>
