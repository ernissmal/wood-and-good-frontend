                  ...
                  <div className="bg-white rounded-lg shadow-md p-8">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-oak-600 text-sm">Lead Craftsman • 25+ years experience</p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-oak-800">Ilze Bērziņa</h4>
                        <p className="text-oak-600 text-sm">Finishing Specialist • 18+ years experience</p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-oak-800">Pēteris Ozols</h4>
                        <p className="text-oak-600 text-sm">Joinery Master • 22+ years experience</p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-oak-800">Anna Liepiņa</h4>
                        <p className="text-oak-600 text-sm">Quality Inspector • 15+ years experience</p>
                      </div>
                    </div>
                  </div>
                </div>
